...
- Ideer bør utveksles, akkurat som varer
...
### Fordelene med det frie markedet
...
For fysiokratene deler ikke friheten. Å bekjempe politiske privilegier og bekjempe økonomiske renter er ett og det samme. Den store nyheten til moderne økonomer, ved daggryet av det 18. århundre, var at de fokuserte på hvert individ med intensjonen om å gjenopprette deres handlingskapasitet samtidig som de tenkte på hvordan man kan inneholde lidenskaper og interesser gjennom det frie markedet.

Faktisk, hvordan få samexistere menn med divergerende interesser? Hva gjør man hvis menn kommer i konflikt, hvis de gjør feil, hvis de er grådige og egoistiske?

Fysiokratene svarte i tre stadier:

1. Det er kontraktsfriheten som tillater løsningen av interessekonflikter, ikke den sosiale kontrakten, som er en pseudo-kontrakt siden den ikke kan brytes. Å analysere sosiale problemer i form av marked og utveksling gjør det mulig for oss å se forholdet mellom individer og mellom nasjoner som et positivt-sum spill og adresserer både spørsmålene om institusjon og regulering av samfunnet ved å hevde at behov og interesse alene styrer forholdet mellom mennesker.
2. Naturlig frihet er retten til å bestemme over seg selv og sine eiendeler. Derfor er harmoni av interesser mulig på grunnlag av respekt for legitim eiendom, som er ervervet gjennom arbeid og stammer fra bruken av våre evner. Og det er denne friheten basert på eiendom som er nøkkelen til det sosiale problemet, ikke lovens begrensning.
3. Statens rolle er å håndheve kontrakter og garantere sikkerheten til folk og eiendom. Dette er det berømte "Laissez faire," mottoet til fysiokratene. Staten styrer bedre når den styrer mindre og lar individer friheten til å ta initiativ og påta seg sitt ansvar.

Kort sagt, hvis alle fritt kan forfølge sin private interesse i respekt for naturlig lov, vil freden og velstanden til alle være bedre sikret enn av en politisk organisasjon som ville definere den generelle interessen ovenfra og pålegge den gjennom lovens begrensning. Politisk frihet er en nyttig ting, men det er ikke nok til å gi individer autonomi til beslutning og handling de trenger. Dette er leksen fra fysiokratene. Den franske liberale skolen fra det 19. århundre, med Say, Constant, Dunoyer, Bastiat og Molinari, vil huske dette og briljant forsvare denne arven mot den fremvoksende sosialismen.
...
> Når det fortsatt ville være hungersnød i provinsene, bør det ikke tas som en innvending mot frihet; det bør bare konkluderes med at friheten ikke har vært etablert lenge nok til å ha produsert alle sine effekter.

Men han møtte hovedsakelig adelenes vrede, som forsøkte å forsvare sine privilegier. Overfor en sammensvergelse montert av prinsen av Conti, foretrakk han å trekke seg i mai 1776 heller enn å gi etter for det han anså som monarkiets og Frankrikes frelse. Hans fall avsluttet det første eksperimentet i Frankrike med en fri markedsøkonomi (For videre lesning, se Edgar Faure, _La disgrâce de Turgot_).
Turgots hovedverk, _Refleksjoner over dannelsen og distribusjonen av rikdom_ (1766), skylder mye til læren til fysiokratene. Turgot gjenopptar og utvider den frie markedsmodelelen foreslått av Quesnay og før ham av Boisguilbert mot merkantilistene. Men hans ideer er minst like mye påvirket av hans venn Jacques Vincent de Gournay, utnevnt til intendant for handel i 1751. Turgot reiste med ham gjennom landet under hans inspeksjonsturer.
Turgot er en apostel av naturretten, som han også kaller "frihetens system". Han understreker ofte at konkurranse i et fritt marked naturlig regulerer priser og forhindrer misbruk. Videre gjør han kjøpmannen til hjørnesteinen i markedsmeekanismen. Faktisk er statlige agenter mindre motiverte og spesielt mindre godt informerte enn kjøpmenn. Derfor er det mer effektivt å overlate handelen til private interesser.
Det er unødvendig å bevise at hvert individ er den eneste dommeren av den mest fordelaktige bruken av deres sinn og armer. De alene besitter den lokale kunnskapen uten hvilken den mest opplyste mannen bare kan resonnere blindt. De alene har en erfaring desto mer pålitelig ettersom den er begrenset til et enkelt objekt. De lærer gjennom sine gjentatte forsøk, deres suksesser, deres tap, og tilegner seg en takt hvis finhet, skjerpet av behovets følelse, langt overgår all teorien til den likegyldige spekulanten. (_Pris til Vincent de Gournay_).
...
> Verdien av ting, skriver han, er basert på deres nytte, eller, som kommer til det samme, på behovet vi har for dem; eller, som igjen kommer til det samme, på bruken vi kan gjøre av dem. Og han legger til: "En ting har ikke verdi fordi den koster, som antatt; men den koster, fordi den har en verdi.
...
- Sivilsamfunnet eksisterer før regjeringen
- Monarkiet er et utdatert og despotisk politisk system.
- Amerika lider under britisk dominans.
- Den amerikanske revolusjonen er en universell sak som forsvarer verdiene av frihet, likhet og ansvar.
- Amerika må skille seg fra England og etablere en republikk for å legemliggjøre disse verdiene.

Forfatteren tar seg bryet med å skille mellom sivilsamfunnet og staten:

> Samfunnet er resultatet av våre behov, regjeringen er det av vår ondskap. \[…\] Den sosiale tilstanden er et gode under alle hypoteser. Regjeringen, selv i sin perfeksjon, er men et nødvendig onde; i sin imperfeksjon, er den et uutholdelig onde.

Suksessen til boken er enorm. Den solgte rundt 100 000 eksemplarer på noen få måneder, i et land med tre millioner innbyggere og den bidrar til å oppildne den amerikanske følelsen av uavhengighet.

Thomas Paine, gjennom sitt pamflett, spilte en avgjørende rolle i den amerikanske revolusjonen og i inspirasjonen av idealene om frihet og demokrati. Han påvirket direkte den amerikanske uavhengighetserklæringen som ble vedtatt noen måneder senere.
...
Derfor er det med stor stolthet vi omfavner fargene i respektens hyllest til denne borgeren av deres store Republikk, og her og nå i skyggen av de illustre døde forsikrer vi ham om vårt hjerte og vår ære for å gi denne krigen et gunstig utfall.

Lafayette, vi er her!

I 1789 var det igjen La Fayette, med Jefferson, som la de første grunnlagene for Menneskerettighetserklæringen fra 1789.
...
Her er det mest berømte avsnittet:
Ved å favorisere suksessen til den nasjonale industrien fremfor den utenlandske industrien, tenker han bare på å gi seg selv større sikkerhet; og ved å styre denne industrien slik at produktet er av høyest mulig verdi, tenker han bare på sin egen gevinst; i dette, som i mange andre tilfeller, blir han ledet av en usynlig hånd for å oppnå et mål som slett ikke er en del av hans intensjoner; og det er ikke alltid det verste for samfunnet at dette målet ikke er en del av hans intensjoner. (_Nasjonenes Velstand_)

Denne berømte usynlige hånden illustrerer ideen om at fri konkurranse i et fritt marked fører til en effektiv allokering av ressurser og en maksimering av generell velvære.

Smiths viktigste bidrag til friheten var å klargjøre ideen om spontan orden. Faktisk argumenterer Smith for at individer, i forsøket på å tilfredsstille sine egne behov og ønsker, oppfordres til å produsere og utveksle varer og tjenester på en måte som møter samfunnets behov mer effektivt enn sentral planlegging kunne.

Denne ideen om spontan orden ville bli et nøkkelkonsept i arbeidet til Friedrich Hayek, som ville anerkjenne sin gjeld til den skotske opplysningstiden og til Adam Smith spesielt.
...
Siden Machiavelli og Hobbes har mennesket blitt forstått som et vesen av lidenskaper, animert av motstridende tendenser. Det var derfor nødvendig å finne regulerende prinsipper for disse lidenskapene for å unngå konfliktene og volden de fører til.
Vi har snakket om økonomer og deres forsvar for det frie markedet. Men for mange filosofer ligger løsningen på problemet heller i etableringen av en suveren makt gjennom en juridisk kontrakt.

Frem til det 18. århundre er det viktigste politiske problemet for disse filosofene derfor spørsmålet om suverenitet. Det er først og fremst et spørsmål om rettferdighet: hvem kan legitimt utøve suverenitet?
...
Men spørsmålet om suverenitetens opprinnelse er ikke det eneste. Refleksjonen kan ta en ny retning, det om utøvelsesmåten av suverenitet. Er den generelle viljen alltid rettferdig? Og fremfor alt, er den autorisert til å gripe inn i sivilsamfunnet og innenfor hvilke grenser?

### Teorien om begrenset makt
...
Locke tildeler staten oppdraget med å forsvare individuell eiendom, som betyr "liv, frihet og eiendom":

> Det store og viktigste målet, derfor, som menn forener seg i samfunn og setter seg under regjering, er bevaringen av deres eiendom. (Two Treatises of Government, § 87).
...
Han argumenterer også for at Amerikas tro på en høyere lov spilte en avgjørende rolle. Uavhengighetserklæringen proklamerer at alle menn er skapt like, at de er utstyrt med visse uavhendelige rettigheter (liv, frihet, eiendom og streben etter lykke) og at regjeringens eneste formål er å sikre disse rettighetene. Det handlet om å gjenopprette prinsipper og idealer som ble tråkket under fot av den britiske kronen.

Det første tillegget til den amerikanske grunnloven, utformet i 1789, sier:
Kongressen skal ikke lage noen lov som respekterer etableringen av en religion, eller forbyr den frie utøvelsen av den; eller forkorter ytringsfriheten, eller pressens frihet; eller retten til folk fredelig å samles, og til å sende inn klager til regjeringen for å få oppreisning for klager.

Denne formuleringen beskytter eksplisitt mot flertallets tyranni. Imidlertid var den franske revolusjonen ganske annerledes. Franskmennene ønsket å bryte helt med fortiden. De århundregamle prinsippene fra den kristne arven møtte ikke lenger forventningene til revolusjonære som Robespierre.

### Fra det tredje ståndets opprør til jakobinernes terror
...
> Er ikke effekten av monopol kjent? Hvis det motløser de det utelukker, er det ikke kjent at det gjør de det favoriserer mindre dyktige? Er det ikke kjent at ethvert arbeid som fjerner fri konkurranse vil bli gjort dyrere og på en verre måte?

Natten til 4. august 1789 er den grunnleggende hendelsen i den franske revolusjonen, enda mer enn 14. juli, som ble valgt som nasjonaldagen. Faktisk, under den økten som ble holdt da, satte Den grunnlovgivende forsamlingen en slutt på det føydalske systemet. Privilegier ble avskaffet, de til adelen og de til kleresiet. I mars 1791, etter flere måneder med en slags juridisk limbo, ble laug også avskaffet, og fullstendig frihet til arbeid ble etablert. Revolusjonen ratifiserte Turgots arbeid. Men ikke for lenge...
I Frankrike, mot slutten av 1791, forverret sulten den populære uroen. Opptøyer lammet kornhandelen, og brød var mangelvare. En stor bevegelse krevde agrarloven, det vil si, statens distribusjon av hvete-produksjonen. Forsamlingen motsto imidlertid dette forsøket på kollektivisering. I første omgang stemte den for konfiskasjon av kirkens eiendommer og, i et andre steg, den Sivile Grunnloven for Presteskapet.
...
Med Rousseau og Robespierre ønsket franskmennene å tro at nasjonen eller den generelle viljen hadde ubegrenset makt og rettferdiggjorde alt. Fra det faktum at folket styrte, ble det konkludert med at de hadde alle rettigheter. Det var tydeligvis en motsetning mellom de store prinsippene for revolusjonen og midlene som ble brukt for å få dem til å seire.

Dette er for øvrig meningen med bemerkningen av Friedrich Hayek i hans bok _The Constitution of Liberty_:

> Den avgjørende faktoren som gjorde revolusjonens anstrengelser til fordel for fremme av individuell frihet forgjeves, var at den skapte illusjonen om at, så lenge all makt hadde blitt overlevert til folket, hadde alle forholdsregler mot misbruk av denne makten blitt unødvendige.

# Apogee og Nedgang: Fra det 19. til det 20. århundre

<partId>39810d57-19e3-5166-8f2e-40b763154148</partId>

## Friheten til de Moderne
...
Denne definisjonen av frihet finnes hos John Stuart Mill:
...
Ifølge Constant har "forvirringen av disse to typer friheter vært, blant oss, under altfor berømte epoker av vår revolusjon, årsaken til mye ondt." Jean-Jacques Rousseau, ved å oppfatte frihet utelukkende som kollektiv deltakelse av borgere i politisk handling, oppmuntret Robespierre til å tvinge borgere gjennom terror. Feiltrinnene til revolusjonen er dermed resultatet av den moderne anvendelsen av politiske prinsipper som var gyldige blant de gamle.

Men dette betyr ikke å ofre politisk frihet, deltakelse i makt. Constant spesifiserer at hvis moderne frihet skiller seg fra gammel frihet, er den truet av en annen type fare. Faren for de gamles frihet var vilkårlighet. Faren for de modernes frihet ville være å frasi seg de politiske garantiene for denne friheten gjennom en slags likegyldighet til det offentlige gode. Med andre ord, det er opp til borgerne å utøve permanent årvåkenhet overfor sine representanter.
...
Politisk frihet uten andre friheter er bare en illusjon ifølge Benjamin Constant. Politisk frihet er friheten til å delta i utøvelsen av makt. Imidlertid kan folkets eller massenes makt være ødeleggende for friheter fordi den gir flertallet retten til å pålegge sin vilje på hele samfunnet, inkludert sine innfall eller sin ideologi for øyeblikket: konfiskerende skatter uten kompensasjon, håndhevelse av en enkelt tanke, sensur, undertrykkelse og intellektuell terrorisme. Derfor kan det ikke være ekte frihet uten borgerlige friheter, inkludert religionsfrihet og økonomisk frihet. Benjamin Constant skiller ikke mellom politisk liberalisme og økonomisk liberalisme:

> I førti år har jeg forsvart det samme prinsippet, frihet i alt, i religion, i filosofi, i litteratur, i industri, i politikk: og med frihet mener jeg triumfen av individualitet, både over autoriteten som vil styre ved despotisme og over massene som hevder retten til å gjøre mindretallet til slaver for flertallet. Despotisme har ingen rett. Flertallet har retten til å tvinge mindretallet til å respektere orden: men alt som ikke forstyrrer ordenen, alt som kun er internt, som mening; alt som, i meningsuttrykk, ikke skader andre, enten ved å provosere materiell vold eller ved å motsi et motsatt uttrykk; alt som, i form av industri, lar rivaliserende industri operere fritt, er individuelt, og kan ikke legitimt underlegges sosial makt.

Med andre ord, i et fritt samfunn, er det nødvendig å etablere en streng grense mellom det offentlige og det private sfæren. Prinsippet for denne grensen ligger i å ikke skade andre, det vil si, ikke krenke deres eiendom.
...
Faktisk betyr likhet i tilstand, som kjennetegner demokrati, at hver person har en tendens til å trekke seg tilbake i seg selv, uten en lenke som fester dem til andre. Den individuelle uavhengigheten som denne nye friheten helliggjør, gjør utøvelsen av sivile dyder vanskelig ved å fremme likegyldighet til det offentlige gode. Som et resultat eksponerer moderne demokratier seg for "myk og regelmessig" despotisme av statisme, denne nye formen for trelldom gjort mulig av folkets voksende uinteresse i politisk liv. Demokrati tenderer dermed symmetrisk mot to ytterligheter som mater hverandre:

På den ene siden, individualisme, det vil si "uinteressen i offentlige saker" og "kjærligheten til materielle gleder." Tocqueville definerer individualisme nøyaktig som en følelse av selvforsyning som fører borgeren til å isolere seg fra andre og trekke seg tilbake i seg selv. Dette er hedonistisk narsissisme.

Og på den andre siden, statisme, som ødelegger individer ved å holde dem i en tilstand av barndom. Staten "arbeider villig for deres lykke, men den ønsker å være den eneste agenten."
Faktisk er utjevningen ledsaget av en større skjørhet hos individer som blir isolerte og separert fra hverandre. For å unngå anarki og beskytte sine eiendeler, stoler de på en unik og sentral makt som de delegerer alle sine rettigheter til. Derfor er det ifølge Tocqueville nødvendig å utvikle sivile foreninger og "lokal demokrati" for å opprettholde motkrefter og dermed bekjempe både individualisme og despotisme, som begge er frihetsdrepende.
...
Rett til arbeid er et godt eksempel på avdriftene av demokratisk egalitarisme. I en tale til Den grunnlovgivende forsamling i 1848, tok Tocqueville stilling mot retten til arbeid i utkastet til konstitusjon. Hvis staten påtar seg å skaffe arbeid til alle arbeidere, argumenterte han, eller hvis den sikrer at de alltid finner det på arbeidsmarkedet, som sosialistene ønsker, vil den bli ledet til å bli "den store og eneste arrangøren av arbeid."

I denne talen sammenligner Tocqueville sosialismen med Ancien Régime, for hvem "dens undersåtter er svake og skrøpelige vesener som alltid må holdes i hånden, for at de ikke skal falle eller skade seg." Sosialismen er dermed "en ny form for trelldom" av tre grunner:

1. Moralsk fremmer sosialismen uansvarlighet gjennom sin direktive og kollektivistiske statskontroll. Den er alltid preget av "en dyp forakt for individet som sådan."

2. Politisk er den despotisk fordi den, i lykkelighetens navn, søker å bli "hver manns herre, hans veileder og hans oppdrager."

3. Økonomisk er den ineffektiv fordi den eliminerer konkurranse gjennom sine reguleringer og sin avvisning av privat eiendom.

### Loven og Dens Misbruk

Hva tenkte Frédéric Bastiat om demokrati? Han svarte så tidlig som i 1846:
...
Under sosialistiske ideers herredømme observerte Bastiat at det elektorale maskineriet ble brukt til å plyndre offentlige midler, slik borgeren:

> Offentlige finanser vil ikke være lenge i å falle inn i fullstendig kaos. Hvordan kunne det være annerledes når staten er oppgitt med å skaffe alt for alle? Folket vil bli knust av skatter, lån vil følge lån; etter å ha utmattet nåtiden, vil fremtiden bli fortært. Til slutt, ettersom det vil bli akseptert i prinsippet at staten er ansvarlig for å skape brorskap til fordel for borgerne, vil hele folket bli forvandlet til bønnfallere. Landeiendom, landbruk, industri, handel, marinen, industrielle selskaper, alt vil røre på seg for å kreve statens gunst. Det offentlige skattkammeret vil bokstavelig talt bli plyndret. ([_Rettferdighet og Brorskap_](http://bastiat.org/fr/justice_fraternite.html))
...
Det er bare når loven overskrider sine rettmessige grenser at lovgiveren blir korrumpert. Dette fører da til en intens kamp mellom ulike kategoriske interesser, alle ivrige etter å kapre det lovgivende apparatet for å oppnå privilegier som per definisjon er plyndrende.

Ifølge Bastiat fører sosialistisk demokrati til et permanent underskudd i budsjetter og til slutt til vold. Faktisk, ved utrettelig å multiplisere løfter, og ved å være ute av stand til å oppfylle dem, utvikler det elektorale maskineriet en bitterhet som legger grunnlaget for revolusjoner. Han skriver:

> Men hvis regjeringen tar det på seg å heve og regulere lønninger og ikke kan gjøre det; hvis den tar det på seg å assistere alle ulykker og ikke kan gjøre det; hvis den tar det på seg å gi pensjoner til alle arbeidere og ikke kan gjøre det... ser vi ikke at ved slutten av hver skuffelse, dessverre! mer enn sannsynlig, er det en like uunngåelig revolusjon? ([_The Law_](http://bastiat.org/fr/la_loi.html))

Bastiats konklusjon:
Ta en titt på kloden. Hvilke er de lykkeligste, mest moralske og mest fredelige folkene? De hvor Loven griper minst inn i privat aktivitet; hvor regjeringen er minst følt; hvor individualiteten har mest motstandskraft og offentlig mening mest innflytelse; hvor administrative mekanismer er færrest og minst kompliserte; skattene minst belastende og minst ulike; folkelig misnøye minst provosert og minst berettiget; hvor ansvaret til individer og klasser er mest aktivt, og hvor, følgelig, hvis moralen ikke er perfekt, tenderer de uunngåelig til å korrigere seg selv; hvor transaksjoner, avtaler, foreninger er minst hindret; hvor arbeid, kapital og befolkning lider minst kunstige forskyvninger ([_The Law_](http://bastiat.org/fr/la_loi.html))

## Den marxistiske kritikken av kapitalismen
...
Den grunnleggende kritikken som Marx retter mot politisk liberalisme, spesielt i sine tidlige skrifter (_Kritikk av Hegels rettsfilosofi_ og _Om jødespørsmålet_), fokuserer på separasjonen mellom sivilsamfunnet og staten. Denne kritikken må forstås innenfor den generelle rammen av hans tolkning av "Borgerrevolusjonen." Det er denne revolusjonen som fører til dannelsen av en stat separert fra sivilsamfunnet, som antas å sikte mot det universelle, altså fellesinteressen, ved å spille rollen som en upartisk megler.

Men alt dette er, for Marx, bare et bedragende utseende. I virkeligheten er staten ikke annet enn et instrument ment for å tjene de herskende klassenes spesielle interesser. Med andre ord, staten er ikke upartisk; den er ikke separert fra sivilsamfunnet. Faktisk er den liberale staten stedet for en dobbel illusjon. Illusjonen om det universelle, som vi nettopp har sett, og følgelig, illusjonen om frigjøring. Revolusjonen frigjorde borgeren ved å innføre folkesuverenitet og likhet for loven, men denne friheten og likheten forblir rent ideelle og abstrakte. Det er feil, sier Marx, å tro, som Rousseau eller Hegel, at mennesket fullt ut realiserer sin rasjonelle natur ved å bli en borger. I virkeligheten kan man bli en borger og forbli utnyttet, slavet, overlatt til lyster, til egoismens anarki, og til den sterkestes lov.

Borgerens frigjøring, ifølge Marx, betyr ikke i det hele tatt menneskets frigjøring, som Erklæringen fra 1789 antyder, men snarere triumfen av destruktiv individualisme og derfor av ulikhet. Frihet som kraften til å gjøre alt som ikke skader andre, en grunnpilar i menneskerettighetene, er en rent negativ frihet som ikke etablerer et forhold mellom menn, men tvert imot fremmer deres separasjon, deres antagonisme, og til slutt deres trelldom. Menneskerettighetenes frihet er en formell frihet.
...
Østerrikske økonomer avviser den marxistiske forestillingen om klassenkamp, ifølge hvilken konflikten mellom kapitalistklassen og arbeiderklassen ville være uunngåelig og ville være motoren for sosial endring.

**All sosial endring er kun mulig gjennom handlingene til individer og ikke fra abstrakte sosiale krefter som klasser.**

Østerrikerne hevder at samfunnet ikke er delt inn i to antagonistiske klasser, men heller består av individer med ulike interesser og behov. De understreker at økonomiske relasjoner mellom individer generelt er gjensidig fordelaktige, og ikke basert på utnyttelse.
...
Konseptet med klassekamp kan også føre til ideen om at alt er tillatt. Marx argumenterte med at forestillinger om godt, ondt, rettferdighet, rett, sannhet, var relative til klasser. Menneskelig fornuft, hevdet han, er medfødt ute av stand til å finne sannheten. Den logiske strukturen i sinnet varierer ifølge sosiale klasser. Det finnes ingen universelt gyldig logikk.
...
Mises skriver:
Marx og marxistene (...) har lært at tanke er bestemt av tenkerens klasse situasjon. Det tanke produserer er ikke sannhet, men ideologier. I konteksten av marxistisk filosofi, betyr dette ordet en forkledning av den egoistiske interessen til klassen som den tenkende individet tilhører. Derfor er det meningsløst å diskutere noe med folk fra en annen sosial klasse. Ideologier trenger ikke å bli tilbakevist ved deduktiv resonnement; de må avsløres ved å denonsere klassens situasjon, den sosiale bakgrunnen til deres forfattere. Således diskuterer ikke marxister fortjenestene av fysiske teorier; de avslører bare den borgerlige opprinnelsen til fysikerne. (_The Omnipotent Government_).

I marxistenes øyne tar Ricardo, Freud, Bergson og Einstein feil fordi de er borgerlige. Således hevder marxister at den logiske strukturen i sinnet ville være forskjellig avhengig av klassemedlemskap. Hver klasse ville ha sin egen logikk og derfor sin egen økonomi, matematikk, fysikk, og så videre. Den eneste logikken og den eneste eksakte, korrekte og evige vitenskapen ville være de marxistenes.

Det er derfor Georges Sorel, importøren av marxismen til Frankrike, ville si at vold er gunstig, forutsatt at den er "proletarisk". Ikke overraskende finner man samme resonnement i skriftene til Lenin, og deretter Trotsky. Siden klassisk moral og lov er oppfinnelser av herskerklassen, er alt tillatt.
...
### Umuligheten av økonomisk beregning
...
Skrevet mellom 1940 og 1943, har dette korte essayet som mål å gi en innledende vurdering av de dirigistiske eksperimentene som ble forsøkt i andre halvdel av 1930-tallet: nasjonaliseringene og den keynesianske etterspørselsstyringen som tok tak i sosialdemokratisk Europa og New Deal-Amerika. Dedikert til "sosialister av alle partier," søker den å demonstrere at "Vesten gradvis har forlatt prinsippet om økonomisk frihet uten hvilken ingen individuell eller politisk frihet tidligere har vært mulig."
Faktisk finner man den samme prosessen med politisk sentralisering og det samme ønsket om å erstatte en dirigistisk organisasjon med de tradisjonelle mekanismene i markedet overalt. I Storbritannia som i USA, hevdes det at offentlig makt må planlegge alt og kan løse alt.
...
### Sosialismens røtter i nazismen
...
> I kapittelet med tittelen "Sosialismens røtter i nazismen," påpeker Hayek at nazismen hevder sosialistisk planlegging (derav navnet, nasjonalsosialisme) av økonomien som et middel for å etablere total kontroll over befolkningen.

Tyske og italienske sosialister banet bare veien for nazismen ved å opprette politiske partier som styrte alle individets aktiviteter, fra fødsel til død, og dikterte deres meninger om alt. Det var ikke fascistene, men sosialistene som begynte å regimentere barn inn i politiske organisasjoner, for å kontrollere deres private liv og deres tanker.

Nazistene adopterte bare den statlige, dirigistiske og intervensjonistiske diskursen som allerede var popularisert av marxistene. Mange fascistledere, som Mussolini i Italia, Laval i Frankrike og Oswald Mosley i Storbritannia, startet sine politiske karrierer som venstreorienterte aktivister før de konverterte til fascisme eller hitlerisme, på grunn av ideologisk nærhet.

Til slutt oppfordrer Hayek sine samtidige til å vende ryggen til "galskapen" og "den samtidige obskurantismen" for å befri menneskeheten fra "feilene som har dominert våre liv i den nylige fortiden." Ifølge ham er den beste garantien for frihet privat eiendom. Når alle produksjonsmidler er konsentrert i hendene på noen få organisatorer, er vi underlagt total makt fordi denne økonomiske makten blir et politisk kontrollinstrument over hele våre liv.

# Velferdsstatens fremvekst i det 20. århundre
...
Faktisk, ifølge Keynes, er langsiktige sparepenger en brems på forbruk og derfor på vekst. Penger må derfor miste sin kjøpekraft over tid for å oppmuntre individer til å forbruke mer og raskere, noe som er en god ting for økonomien. I keynesiansk logikk av stimuleringspolitikk, er hovedfienden sparing.

Ifølge Keynes kan denne fienden bekjempes med lavrentelikviditet. Derfor må sentralbankene monopolisere og kontrollere penger.

Med Keynes ble det 20. århundre århundret for tillit til eksperter og planlegging. De sosiale ingeniørene ved roret av regjeringen og pengepolitikken kan trekke i spaker som antas å gjenopprette velstand, siden de besitter en makroøkonomisk visjon av verden.

### Den Kontroversielle Arven etter Keynes
...
I 1947, fem år etter den franske oversettelsen av _The General Theory_, publiserte han en artikkel med tittelen: _Feilene ved Lord Keynes' generelle teori_. Han ga følgende advarsler:
...
> Det er gjennom budsjettunderskudd at menn mister sin frihet.
...
### Gull som den globale standarden
...
Dette er grunnen til at Ludwig von Mises skriver i _Human Action_:

> Gullstandarden var verdensstandarden i kapitalismens æra, av økende velstand, frihet og demokrati \[…\] Det var den internasjonale standarden som internasjonal handel og verdens kapitalmarkeder trengte \[…\] Den førte industri, kapital og vestlig sivilisasjon til de mest avsidesliggende hjørner av planeten, og skapte tidligere ukjent rikdom.
> Men gullstandarden begrenser regjeringers evne til å finansiere sine utgifter gjennom skatter i stedet for inflasjon, noe som forklarer en viss fiendtlighet fra politiske og økonomiske eliter mot dette systemet. Fordi det å knytte valuta til et edelt metall begrenser sentralbankenes evne til å finansiere veksten av velferdsstaten gjennom den indirekte skatten som er inflasjon.
> Det er derfor så tidlig som i 1923, Keynes erklærte:

> I sannhet er gullstandarden allerede et barbarisk relikvie. (...) Forsvarerne av den gamle standarden merker ikke hvor langt den nå er fjernet fra ånden og behovene til de nye tidene. (J.M. Keynes, _Monetary Reform_).
...
> Gull, som ikke endrer sin natur, som ikke har noen nasjonalitet, som holdes, evig og universelt, som den uforanderlige verdien par excellence.

### Et penge marked uten statlig monopol er mulig
...
> Så lenge vi ikke har gjenopprettet en situasjon der regjeringer (så vel som andre offentlige myndigheter) vet at hvis de bruker for mye vil de, som hvem som helst andre, være ute av stand til å møte sine forpliktelser, vil det ikke være noen pause i denne prosessen som, ved å erstatte kollektiv aktivitet med privat aktivitet, truer med å kvele individuelt initiativ. Under den nåværende ubegrensede demokratiet, der regjeringen har makt til å tildele spesielle materielle fordeler til bestemte grupper, er den tvunget til å kjøpe støtten fra nok av dem for å utgjøre et flertall. (Ch. XXI, Effektene av finans og offentlige utgifter).
...
Denne situasjonen er faktisk konsekvensen av en radikal intellektuell endring i ideer. Siden slutten av det 19. århundre har Europa forlatt ideene som hadde tillatt det å bli et velstående og opplyst kontinent. En stund motsto dets eldste datter, Amerika, kollektivismens vinder før den også ble overveldet av dem.

I 1941 gjorde George Orwell denne vurderingen:

> Det er klart at frikapitalismens tidsalder nærmer seg slutten og at det ene landet etter det andre tar i bruk en sentralisert økonomi som kan kalles sosialisme eller statskapitalisme, som du vil. I dette systemet forsvinner den økonomiske friheten til individet og i stor grad hans frihet generelt - friheten til å handle, velge sitt arbeid, bevege seg rundt - . Det er bare veldig nylig at vi har begynt å ane implikasjonene av dette fenomenet. Tidligere hadde det aldri blitt forestilt at forsvinningen av økonomisk frihet kunne påvirke intellektuell frihet. Det ble vanligvis tenkt at sosialisme var en slags liberalisme forsterket med en moral. Staten ville ta hånd om ditt økonomiske liv og frigjøre deg fra frykten for fattigdom, arbeidsløshet osv., men den ville ikke ha behov for å blande seg inn i ditt private intellektuelle liv. Nå er beviset gjort at disse synspunktene var feil.

Men i motsetning til hva dommedagsprofetene kunngjør, er ikke vestlig sivilisasjon dømt til å forsvinne i det 21. århundre. Den har ikke uttømt sine potensialer. Friheten er ennå ikke fullt realisert.

Dette er hva Murray Rothbard foreslo i 1982:
Vi har nå opplevd alle variantene av statisme, og de har alle mislyktes. Overalt i den vestlige verden i begynnelsen av det 20. århundre, begynte forretningsledere, politikere og intellektuelle å kalle etter et "nytt" blandet økonomisystem, med statsdominans, i stedet for det relative laissez-faire fra forrige århundre. Nye panaceaer, tiltalende ved første øyekast, som sosialisme, korporativstaten, Velferds-Krigsstaten osv., ble prøvd og alle har åpenbart mislyktes. Argumentene til fordel for sosialisme og statsplanlegging fremstår nå som bønner for et aldrende, utmattet og mislykket system. Hva gjenstår å prøve om ikke frihet?
