...
Jika gaji kita tidak meningkat seiring dengan inflasi, kita sebenarnya mendapatkan uang yang lebih sedikit seiring berjalannya waktu. Ini karena biaya hidup meningkat, tetapi gaji kita tetap sama. Hal ini menyebabkan penurunan daya beli kita, membuatnya lebih sulit untuk mempertahankan standar hidup yang sama seperti sebelumnya.
...
Akibat dari manipulasi suku bunga, ekspansi ekonomi cenderung berlangsung lebih lama, menyebabkan peningkatan tingkat utang dan ketidakbertanggungjawaban fiskal. Sebaliknya, kontraksi ekonomi menjadi lebih parah, memperburuk ketidakstabilan dan kesulitan bagi mereka yang berada di bagian bawah tangga sosial.
...
Namun, meskipun memiliki keunggulan sebagai solusi layer one, Bitcoin juga dapat bersaing dengan metode transaksi layer two. Ada teknologi yang dibangun di atas jaringan Bitcoin, seperti Lightning, yang memungkinkan pengguna untuk bertransaksi hampir secara instan dan dengan biaya sebagian kecil dari sen. Teknologi ini dapat dianggap sebagai solusi layer two untuk jaringan Bitcoin. Dengan pemikiran ini, sama seperti sistem moneter tradisional kita memiliki transaksi layer one dan dua, begitu juga dengan Bitcoin.
...
2. **Mining:** Mining adalah cara lain untuk berkontribusi pada jaringan Bitcoin dan berpotensi mendapatkan bitcoin. Meskipun membutuhkan sedikit lebih banyak sumber daya daripada menjalankan node dan tidak seprofitable seperti dulu, mining adalah aktivitas yang memberi hadiah bagi mereka yang tertarik pada aspek teknis dari jaringan.
...
5. Bayangkan Anda tinggal di negara yang mengalami inflasi tinggi. Bagaimana bitcoin dapat menyediakan solusi untuk menjaga daya beli Anda?
...
Pertama, [seperempat](https://www.worldbank.org/en/publication/globalfindex) individu secara global dianggap tidak memiliki akses ke bank. Artinya, ada lebih dari satu miliar individu yang tidak dapat bertransaksi secara digital, apalagi menyimpan dengan aman.
...
Untuk memperburuk keadaan, kecuali kita beralih ke uang tunai, semua dana kita tunduk pada batasan perbankan tradisional. Ini menyajikan risiko yang signifikan jika pemerintah kita memberlakukan reformasi perbankan yang memberatkan, seperti yang terlihat selama kebangkrutan pemerintah Yunani pada tahun 2015.
...
Ini menimbulkan pertanyaan: Mengingat gesekan dengan perbankan tradisional dan bahwa volatilitas jangka pendek bitcoin dapat dilihat sebagai hambatan bagi mereka dengan tabungan minimal, bagaimana kita dapat bertransaksi dengan aman di era digital tanpa menghadapi risiko dan keterbatasan ini?
...
Dan inilah di mana Tether masuk.
...
Setelah kemunculan Tether, banyak perusahaan dan inisiatif lain meluncurkan produk Stablecoin serupa. Upaya-upaya ini dapat secara luas dikategorikan menjadi tiga tipe utama: stablecoin yang didukung fiat, didukung komoditas, dan stablecoin algoritmik.

- **Stablecoin yang didukung fiat**, seperti USDt Tether, didukung oleh mata uang tradisional seperti dolar AS atau Euro, dan nilai mereka secara langsung terikat pada nilai mata uang fiat yang mendasarinya.
- **Stablecoin yang didukung komoditas** didukung oleh komoditas seperti emas atau minyak, misalnya, stablecoin emas Tether, XAUt,
- **Stablecoin algoritmik** mengandalkan serangkaian aturan atau algoritma untuk mempertahankan nilai mereka. Dikatakan demikian, kita belum melihat stablecoin murni algoritmik yang berhasil di pasar.

Kesimpulannya, seiring dengan terus berkembangnya masyarakat kita dan kemajuan teknologi, begitu pula hubungan kita dengan uang. Dari koin ke mata uang digital, kita telah melihat pergeseran dalam cara kita berinteraksi dan bertransaksi menggunakan uang. Sementara sistem perbankan tradisional memiliki keterbatasannya, Tether, melalui pilihan stablecoin-nya, menawarkan solusi potensial untuk tantangan-tantangan ini. Dengan menyediakan stabilitas jangka pendek relatif dari mata uang tradisional dengan fleksibilitas dan aksesibilitas mata uang digital asli, stablecoin mereka menawarkan pengguna kontrol yang lebih besar atas uang mereka. Baik Anda kekurangan akses ke layanan perbankan, menghadapi campur tangan pemerintah atau hanya perlu bertransaksi di luar jam perbankan tradisional, stablecoin seperti USDt dapat menyediakan alternatif yang dapat diandalkan. Akibatnya, mereka cepat menjadi bagian integral dari sistem keuangan kita.

_**Catatan Samping:** Jangan khawatir jika beberapa istilah ini tidak terlalu masuk akal. Kami akan menjelajahi setiap topik ini dengan lebih detail sepanjang modul ini._
...
Bitshares memperkenalkan stablecoin pertama yang disebut “bitUSD,” yang dirancang untuk dipatok ke dolar AS, dengan nilai satu bitUSD selalu sama dengan satu dolar AS. Ini berarti bahwa bitUSD didukung oleh dolar AS yang disimpan sebagai cadangan, memastikan nilai tetap stabil di saat volatilitas pasar. Di sisi lain, NuBits menggunakan mekanisme pasokan dan permintaan untuk mempertahankan patokannya ke dolar AS. Namun, lebih lanjut tentang itu di bab berikutnya.

Meskipun ada upaya awal ini, baru setelah peluncuran USDt oleh Tether pada tahun 2014 stablecoin mulai mendapatkan perhatian utama. USDt, sama seperti bitUSD, adalah stablecoin yang dirancang untuk dipatok ke dolar AS, dengan nilai satu USDt sama dengan satu dolar AS. USDt diciptakan oleh sebuah perusahaan bernama Tether Limited, yang perusahaan induknya juga memiliki bursa cryptocurrency Bitfinex.

Awalnya, Tether terutama digunakan oleh pedagang untuk memindahkan dana antar bursa tanpa perlu konversi ke mata uang fiat. Namun, seiring semakin banyak orang yang menggunakan Tether, stablecoin ini mendapatkan momentum dan popularitasnya sendiri. Saat ini, Tether adalah stablecoin yang paling banyak digunakan secara global, memproses lebih dari \$30 miliar setiap hari. Untuk memberikan perspektif, [MasterCard](https://www.cardrates.com/advice/number-of-credit-card-transactions-per-day-year/#:~:text=4%20billion%20transactions%20were%20processed,a%20Japanese%20credit%20card%20company)) dan [Visa](https://blog.unibulmerchantservices.com/processing-24000-visa-transactions-per-second-how-its-done/#:~:text=VisaNet%2C%20the%20card%20network's%20payment,24%2C000%20Visa%20transactions%20per%20second.) memproses, rata-rata, \$8.1 miliar dan \$12 miliar per hari, masing-masing. Pada dasarnya, 50% lebih banyak dolar AS ditransaksikan setiap hari di USDt dibandingkan Visa dan Mastercard digabungkan.
...
Misalkan Anda memiliki \$50 AS dan ingin mengirim uang ini kepada teman dan keluarga Anda menggunakan USDt. Untuk memulai proses ini, Anda masuk ke bursa online Anda dan menukar \$50 dolar AS Anda dengan \$50 USDt. Namun, pertukaran ini tidak sekadar menciptakan \$50 USDt baru. Sebaliknya, secara berkala, ketika cadangan USDt bursa menipis, penerbit, dalam skenario ini, Tether, menghasilkan USDt baru untuk bursa sebagai imbalan untuk USD. USD tersebut mendukung token USDt yang baru dibuat ini. Ini memastikan bahwa setiap \$1 USDt yang beredar didukung oleh uang tunai atau setara kas yang setara.
...
[Tether Gold](https://gold.tether.to/) (XAUt) adalah contoh dari stablecoin yang didukung komoditas di mana Tether menyimpan satu troy ons emas murni untuk setiap token yang diterbitkan. Ini memastikan harganya bergerak seiring dengan harga komoditas yang mendasarinya, dalam hal ini… emas.

Yang menarik untuk dicatat tentang XAUt adalah bahwa pemegang token dapat melacak kepemilikan emas perusahaan untuk memastikan transparansi, meminimalkan kesalahan perilaku. Selain itu, mereka dapat menukar token mereka dengan emas kapan saja, memberikan keamanan dan fleksibilitas tambahan.
...
**Mengapa seseorang mungkin menginginkan ini?** Di dunia fisik, membeli satu ons emas seharga \$1900 mungkin di luar jangkauan banyak orang. Tapi 1/1000 dari satu ons emas sekarang dapat dicapai melalui fraksionalisasi token. Di ranah digital, klaim terhadap debu emas menjadi mungkin— sesuatu yang tidak mungkin di dunia fisik.
...
Sebuah stablecoin algoritmik adalah tipe stablecoin terakhir yang akan kita bahas dan, sama seperti yang lainnya, dirancang untuk mempertahankan nilai yang stabil. Tidak seperti stablecoin lain yang didukung oleh aset fisik, stablecoin algoritmik menggunakan rumus matematika atau algoritma—seringkali bersamaan dengan beberapa aset—untuk mengatur suplai mereka sehubungan dengan permintaan guna mempertahankan stabilitas harga.
...
Mari kita katakan kita merilis stablecoin algoritmik baru yang disebut AlgoCoin yang menggunakan metode rebase untuk memastikan harga \$1. Dalam skenario seperti itu, AlgoCoin akan secara otomatis menyesuaikan suplai token untuk mempertahankan harga yang stabil. Ini akan dicapai dengan meningkatkan atau mengurangi suplai token berdasarkan perubahan harga token.

Jika harga AlgoCoin di atas \$1, algoritma akan meningkatkan suplai token, secara efektif mengurangi harga setiap token. Sebaliknya, jika harga AlgoCoin di bawah \$1, protokol dapat dengan cara tertentu mengurangi suplai token untuk meningkatkan harga setiap token.
...
Sekarang, penting untuk dicatat bahwa mengurangi suplai token yang beredar, misalnya, dengan membelinya secara otomatis di harga pasar atau dengan menghancurkan beberapa suplai dengan biaya atau biaya penyimpanan, semua tanpa merusak utilitasnya dan dengan demikian permintaannya, tidak semudah yang mungkin terlihat. Ketika stablecoin algoritmik mengandalkan set aturan yang kompleks untuk mempertahankan stabilitas harga mereka, ini membuat mereka rentan terhadap kerentanan teknis dan finansial. Yang, jika Anda mengikuti ruang ini, dimanfaatkan secara teratur.

Pada Mei 2022, beberapa pedagang mengeksploitasi kerentanan dalam TerraUSD (UST), salah satu stablecoin algoritmik utama. Akibatnya, nilai UST anjlok dari \$18,7 miliar menjadi di bawah \$100 juta dalam sebulan, mewakili penurunan yang mengejutkan [99,5%](https://www.coingecko.com/en/coins/terraclassicusd).

Dengan ini di pikiran, sementara stablecoin algoritmik telah mendapat perhatian untuk potensi mereka dalam merevolusi cara kita memikirkan nilai stabil di dunia digital, penting untuk dicatat bahwa mereka masih merupakan konsep yang relatif baru dan telah rentan terhadap bug dan kerentanan. Karena mereka hanya sebagian, atau kadang-kadang, tidak didukung oleh aset fisik dan sangat bergantung pada pengembang dan pengkodean, serta pada upaya rekayasa keuangan yang halus, kami merekomendasikan untuk berhati-hati dan meneliti secara menyeluruh sebelum menggunakan stablecoin algoritmik apa pun.

Kesimpulannya, stablecoin menawarkan jembatan antara dunia tradisional dan Bitcoin, memungkinkan kompromi yang berbeda antara kedaulatan dan praktikalitas. Meskipun ada tiga tipe utama stablecoin—yang didukung oleh mata uang fiat, logam mulia, atau algoritma—stablecoin yang didukung fiat adalah yang paling populer.

Meskipun stablecoin sering dianggap aman karena sifatnya yang "stabil", penting untuk diingat bahwa mereka tidak sepenuhnya bebas risiko. Karena stablecoin mengandalkan penerbit terpusat, yaitu Tether, dan lembaga keuangan, ada potensi kerugian. Untuk mengurangi risiko ini, sangat penting untuk meneliti berbagai stablecoin sebelum berinvestasi. Dengan melakukan ini, Anda dapat membuat keputusan yang tepat dan meminimalkan potensi kerugian yang tidak terduga.
...
Seperti yang ditunjukkan oleh cerita Adanna, inflasi adalah kenyataan yang menyakitkan bagi banyak individu di seluruh dunia, terutama mereka yang tinggal di negara-negara dengan ekonomi tidak stabil. Namun, sementara inflasi signifikan dulunya hanya masalah di negara-negara berkembang, selama dua tahun terakhir, tingkat inflasi telah berlipat ganda di [37 dari 44](https://www.weforum.org/agenda/2022/06/inflation-stats-usa-and-world/) ekonomi maju. Itu berarti, per Oktober 2022, [81](https://www.visualcapitalist.com/mapped-which-countries-have-the-highest-inflation/) negara sekarang melaporkan inflasi dua digit. Itu hampir setengah dari semua negara yang melaporkan inflasi!
...
Selain USDt yang dipatok ke USD, Tether menawarkan XAUt—yang didukung oleh emas—menawarkan alternatif yang lebih kuat bagi orang-orang yang ingin menghindari tingkat inflasi tinggi. Emas telah menjadi penyimpan nilai yang terpercaya selama berabad-abad, berkat kelangkaannya dan stabilitas harganya. Namun, sampai baru-baru ini, tidak mungkin menggunakan emas sebagai sarana pembayaran digital. XAUt, yang didukung oleh emas, menyelesaikan masalah ini dengan menyediakan metode transaksi emas tanpa perlu kepemilikan fisik. Akibatnya, orang dapat melindungi daya beli mereka terlepas dari apakah mata uang mereka atau USD yang mengalami inflasi tinggi.
...
Kedua, eGold memulai debutnya selama periode ketika pasar cryptocurrency jauh kurang berkembang. Akibatnya, ia bergulat untuk mencapai pengakuan yang luas. Tantangan gabungan ini mengakibatkan eGold menghadapi hambatan regulasi yang signifikan dan komplikasi hukum, yang pada akhirnya menyebabkan kejatuhannya.
...
Pada akhirnya, stablecoin menawarkan solusi yang menarik bagi orang-orang yang tinggal di negara-negara dengan ketidakstabilan atau inflasi tinggi. Dengan menyediakan akses ke mata uang yang lebih stabil atau dengan memungkinkan transaksi dalam emas, stablecoin menawarkan cara bagi orang-orang untuk melindungi nilai tabungan mereka dan lepas dari efek negatif inflasi. Seiring semakin banyak orang menyadari manfaat dari stablecoin, popularitasnya kemungkinan akan terus tumbuh sebagai sarana untuk menyediakan stabilitas finansial dalam dunia yang tidak pasti.

#### Peningkatan Kemudahan Penggunaan

Mengingat semua yang telah kita bahas sejauh ini, saya memiliki perasaan Anda mulai memahami bagaimana stablecoin menawarkan kemudahan penggunaan yang lebih tinggi dibandingkan mata uang tradisional. Tapi untuk memastikan, mari kita tekankan sedikit lagi. Penawaran stablecoin dari Tether telah merevolusi dunia keuangan dengan menawarkan tingkat kemudahan penggunaan yang tidak dapat ditandingi oleh mata uang fiat tradisional.
...
5. Menurut Anda, tindakan apa yang harus diambil oleh penerbit stablecoin untuk memastikan stabilitas dan kepercayaan stablecoin mereka? Seberapa penting bagi penerbit stablecoin untuk transparan tentang praktik cadangan mereka dan menyediakan laporan secara rutin?
...
Hal ini menimbulkan pertanyaan: Apa yang membuat orang berpikir bahwa Bitcoin adalah gelembung yang menunggu untuk pecah?
...
Pertama, volatilitas bitcoin adalah topik perdebatan yang hangat dan telah menyebabkan beberapa orang mengkritik aset tersebut karena pergerakan harga yang tajam. Kami percaya ini adalah pandangan sempit tentang volatilitas karena volatilitas mengukur pergerakan harga aset, tidak hanya penurunannya. Mereka yang memiliki keberanian untuk memegang bitcoin melalui fluktuasinya telah diberi imbalan yang kaya. Ambil contoh aset A dan B. Aset A rata-rata meningkat sebesar 10% per tahun dengan deviasi 15%, sementara aset B bergerak sebesar 5% per tahun dengan deviasi 10%. Meskipun aset B memiliki volatilitas lebih rendah dari aset A, aset A mengungguli aset B dalam jangka panjang. Anda harus bersedia menanggung volatilitas untuk menuai imbalan dari pergerakan harga bitcoin. Selain itu, USD mungkin kurang fluktuatif dari hari ke hari. Namun, jika Anda telah memegang mata uang tersebut selama 100 tahun terakhir, Anda telah kehilangan [96%](https://www.visualcapitalist.com/purchasing-power-of-the-u-s-dollar-over-time/) dari daya beli Anda.
...
Bitcoin sering kali ditolak karena tidak didukung oleh sesuatu yang bernilai, seperti emas atau mata uang pemerintah. Ide bahwa, mengingat bitcoin tidak didukung oleh sesuatu yang nyata, maka harus tidak berharga adalah kesalahan berpikir.
...
Bitcoin memilih untuk memprioritaskan desentralisasi dan keamanan daripada skalabilitas. Namun, skalabilitas ini masih dicapai. Hanya saja, hal itu dilakukan melalui cara alternatif (Dibahas dalam kesalahpahaman berikutnya). Kriptokurensi lain, bagaimanapun, sering memprioritaskan skalabilitas, tetapi dalam melakukannya, mereka mengorbankan desentralisasi, membuat mereka rentan terhadap serangan atau tidak berbeda dari mata uang fiat atau sekuritas.
...
Tetapi Bitcoin juga bersaing dengan metode transaksi lapisan dua, dengan teknologi seperti Lightning yang dibangun di atas lapisan satu. Lightning memungkinkan transaksi hampir instan dengan biaya minimal, membuat mikrotransaksi dan pembelian kecil menjadi mungkin. Sejak El Salvador mengadopsi Bitcoin sebagai alat pembayaran legal, masyarakat umum telah menggunakan Lightning untuk bertransaksi dengan Bitcoin karena manfaatnya yang tak tertandingi, seperti waktu transaksi yang hampir instan dan biaya sebagian kecil dari sen. Ini membuatnya sangat cocok untuk pedagang kecil dan individu.
...
Meskipun banyak studi membantah klaim palsu tersebut, jelas bahwa beberapa individu memiliki agenda dan bertekad untuk membangun narasi negatif dan tidak faktual seputar Bitcoin. Kenyataannya adalah bahwa Bitcoin memiliki potensi untuk membawa perubahan positif yang signifikan di dunia, mulai dari memberikan akses ke layanan keuangan bagi yang tidak memiliki bank hingga mengurangi biaya transaksi dan meningkatkan kebebasan finansial.
...
...dianggap ilegal di yurisdiksi masing-masing. Ini menekankan bahwa apa yang dianggap ilegal tidak hitam atau putih. Ada hubungan kompleks antara definisi hukum dan nilai-nilai beragam yang dijunjung tinggi di berbagai wilayah.

#### Kesalahpahaman Ketujuh: Siapa pun dapat menduplikasi kode Bitcoin, membuatnya tidak berharga

Argumen bahwa kode Bitcoin dapat dengan mudah disalin dan, oleh karena itu, tidak berharga melewatkan aspek penting dari apa yang memberikan nilai kepada bitcoin. Meskipun benar bahwa kode untuk Bitcoin bersifat open source dan dapat disalin, nilai bitcoin tidak hanya berasal dari utilitas yang ditawarkannya.
...
Juga penting untuk dicatat bahwa kritik terhadap penggunaan energi Bitcoin sering berasal dari individu di masyarakat yang berprivilegi dan berkembang. Individu-individu ini biasanya memiliki akses ke fasilitas perbankan, menggunakan pengering pakaian, mengandalkan pendingin udara untuk pemanasan atau pendinginan, menghias rumah mereka dengan lampu Natal, dan sering terlibat dalam liburan ke luar negeri atau jarak jauh. Semua usaha ini mengonsumsi energi.
...
Sama seperti energi yang dikonsumsi dalam penambangan emas fisik, penambang Bitcoin mengonsumsi energi dalam usaha mereka untuk memperoleh bitcoin. Kebutuhan akan energi nyata ini mengikat aset digital yang sebaliknya tidak berwujud ke dunia fisik. Selain itu, dengan jaringan penambang yang luas secara global mengeluarkan energi untuk mengamankan jaringan Bitcoin, konsumsi energi untuk memperoleh bitcoin berfungsi sebagai mekanisme pertahanan yang kuat terhadap sentralisasi dan manipulasi yang tidak semestinya. Untuk alasan ini, sangat sulit bagi entitas terpusat untuk mengambil alih jaringan atau memanipulasi aturan demi keuntungan mereka, karena mereka harus bersaing dengan penambang yang tersebar secara global.

Dalam hal ini, mari kita lihat tiga poin diskusi di atas.
...
Namun, dengan Bitcoin, para insinyur telah merancang cara untuk memanfaatkan gas alam terbuang ini dengan mengubahnya menjadi energi untuk menyalakan penambang Bitcoin. Terobosan ini tidak hanya menyediakan aliran pendapatan tambahan bagi perusahaan-perusahaan ini tetapi juga memiliki manfaat lingkungan yang signifikan. Dengan memanfaatkan gas bakar untuk menghasilkan listrik untuk penambangan Bitcoin, perusahaan-perusahaan ini dapat [mengurangi emisi](https://batcoinz.com/quantifying-the-impact-of-using-stranded-methane-on-the-bitcoin-network/) yang sebaliknya akan mencemari udara yang kita hirup. Pada intinya, Bitcoin bersifat karbon-negatif dalam skenario ini dengan menawarkan cara untuk mengurangi emisi dan memanfaatkan sumber energi yang sebelumnya dibuang.

Secara keseluruhan, mengingat penambang Bitcoin termotivasi untuk mencari sumber energi yang hemat biaya, seringkali lebih memilih energi terbarukan, Bitcoin memiliki salah satu campuran energi [paling berkelanjutan](https://bitcoinminingcouncil.com/wp-content/uploads/2021/07/2021.07.01-BMC-Q2-2021-Materials.pdf) di antara industri dan bahkan negara-negara. Jadi, kali berikutnya seseorang mengungkapkan kekhawatiran tentang jejak lingkungan Bitcoin, Anda dapat dengan percaya diri menanggapi dengan fakta bahwa Bitcoin berada di garis depan praktik energi berkelanjutan.
...
- Akses perbankan untuk populasi yang tidak memiliki bank
...
- Monetisasi langsung dari energi terdampar
...
Untuk mengakhiri, kami berharap kesalahpahaman tentang Bitcoin ini telah memberi Anda pemahaman yang lebih dalam tentang Bitcoin di luar kritik permukaan yang sering diterimanya. Setelah pemeriksaan lebih dekat, sekarang seharusnya jelas bahwa banyak dari kritik ini terbukti tidak berdasar. Dengan ini di pikiran, saatnya untuk mengalihkan fokus dari penggambaran yang salah tentang Bitcoin dan menuju pemahaman yang lebih komprehensif tentang sistem keuangan yang lebih luas. Dengan melakukan ini, kita dapat bekerja menuju penciptaan sistem yang lebih adil dan setara yang menguntungkan semua orang, bukan hanya mereka yang berkuasa.

Mari kita sekarang beralih perhatian kita ke kesalahpahaman umum seputar stablecoin...
...
#### Kesalahpahaman Satu: Kebanyakan stablecoin tidak sepenuhnya didukung oleh cadangan

Saat memahami stablecoin, sangat penting untuk mengakui bahwa setiap stablecoin beroperasi di bawah prinsip dan kerangka kerja yang unik. Beberapa proyek stablecoin menunjukkan kehati-hatian dan transparansi yang luar biasa dengan menyediakan informasi rinci tentang cadangan mereka dan secara rutin merilis pernyataan yang memverifikasi hal tersebut.
...
Pertama, penerbit stablecoin seringkali berinvestasi dalam setara kas daripada menahan uang tunai, karena uang tunai dapat berdampak signifikan pada neraca penerbit stablecoin. Dengan peraturan perbankan saat ini, aset neraca apa pun, seperti uang tunai, berisiko kehilangan dalam kejadian bangkrut, dan Federal Deposit Insurance Corporation (FDIC) hanya menyediakan cakupan asuransi hingga \$250.000 USD, dengan jumlah yang melebihi batas ini berisiko. Untuk mengurangi paparan ini, stablecoin yang bertujuan untuk melindungi pengguna dari kejadian tak terduga seringkali berinvestasi dalam surat berharga pemerintah. Dengan berinvestasi dalam aset seperti surat berharga, tidak hanya mereka menghasilkan imbal hasil, aset-aset ini dapat dianggap sebagai sekuritas di luar neraca. Akibatnya, penerbit stablecoin dapat melindungi dana mereka dalam kejadian bangkrut bank, karena sekuritas ini dapat dikembalikan kepada pelanggan. Ilustrasi yang meyakinkan dari hal ini terjadi pada Februari/Maret 2023, melibatkan Silicon Valley Bank (SVB) dan Circle, perusahaan di balik stablecoin USDC. Pada saat itu, Circle memiliki deposit uang tunai yang substansial [\$3.3 miliar](https://www.coindesk.com/business/2023/03/11/circle-confirms-33b-of-usdcs-cash-reserves-stuck-at-failed-silicon-valley-bank/#:~:text=Stablecoin%20issuer%20Circle%20said%20late,reserves%20backing%20Circle's%20stablecoin%20USDC.) di SVB. Dan kemudian, SVB bangkrut. Untuk menghindari bencana finansial, FDIC turun tangan untuk menyelamatkan Circle dan perusahaan lain yang terdampak dengan menutupi dana yang hilang. Namun, ini bukan jalur tindakan standar. Kejadian tak terduga ini menandai pertama kalinya dalam sejarah situasi seperti itu terungkap. Tanpa intervensi FDIC, Circle mungkin menghadapi kebangkrutan juga.

Kedua, kita sering mengkritik penerbit stablecoin karena berinvestasi dalam aset non-kas, namun sistem perbankan kita yang ada beroperasi pada dasar cadangan fraksional. Dengan kata sederhana, bank tidak memiliki cadangan yang cukup untuk memenuhi permintaan penarikan dari pelanggan mereka. Jika sebagian besar populasi nasional kita menarik deposit mereka, sektor perbankan akan segera runtuh. Bahkan, sejak 2020, persyaratan cadangan di Amerika Serikat telah ditetapkan pada [nol](https://www.federalreserve.gov/monetarypolicy/reservereq.htm), berarti bank tidak diwajibkan untuk menyimpan **APAPUN** deposit pelanggan.
...
Singkatnya, lain kali stablecoin diperdagangkan di atas atau di bawah harga yang dimaksudkan, sadarilah perbedaan antara volatilitas harga jangka pendek yang disebabkan oleh masalah likuiditas dan kejadian depegging yang sebenarnya.
...
Dengan ini di pikiran, sementara kami memprioritaskan bitcoin untuk tabungan jangka panjang karena ketiadaan perantara atau individu yang dapat mengambil alih jaringan, stablecoin terpusat masih memiliki beberapa manfaat, yaitu sementara sifat terpusat dari stablecoin memungkinkan untuk pembekuan dana potensial, sifat ini dapat menjadi alat yang berharga dalam memerangi aktivitas ilegal dan melindungi pengguna.

#### Kesalahpahaman Empat: Anda akan kehilangan dana Anda jika rantai dasar turun

Salah satu kesalahpahaman umum tentang stablecoin adalah bahwa Anda akan kehilangan dana Anda jika rantai dasar dari stablecoin tersebut turun. Oleh karena itu, kami merasa penting untuk menjelaskan bagaimana stablecoin beroperasi pada lapisan transport mereka, seperti TRON, Ethereum, dan Algorand, di antara lainnya. Meskipun pada awalnya mungkin mengkhawatirkan untuk kehilangan akses ke stablecoin Anda ketika rantai dasar menghadapi masalah, Anda akan senang mengetahui ada langkah-langkah yang ditempatkan untuk melindungi dana Anda.
...
1. Dalam kebanyakan kasus, gangguan di rantai dasar adalah hambatan sementara, dan rantai akan segera berfungsi kembali. Gangguan ini sering kali dapat diatasi, memungkinkan pengguna untuk mendapatkan kembali akses ke stablecoin mereka.
2. Dalam kasus yang lebih signifikan, seperti peretasan besar atau kegagalan rantai, Tether dapat mengambil tindakan perbaikan. Mereka mungkin mendirikan situs web penataan untuk pemegang USDt dari rantai yang tidak berfungsi. Melalui situs web ini, pengguna kemudian dapat membuktikan kepemilikan token USDt mereka menggunakan kunci pribadi mereka. Setelah kepemilikan dikonfirmasi, Tether dapat membakar token USDt yang tidak berfungsi yang dipegang oleh pengguna dan menerbitkannya kembali di rantai yang berfungsi. Token USDt yang diterbitkan ulang kemudian dikirimkan kepada pengguna, memastikan kelanjutan dana mereka.
...
Untuk mengakhiri... Ingatlah, Bitcoin dan stablecoin secara inheren menantang struktur kekuasaan dan otoritas pemerintah yang sudah ada, yang secara alami mengundang penolakan. Banyak dari resistensi ini sering muncul dari ketakutan akan mengganggu sistem keuangan yang ada dan mempertanyakan kontrol pemerintah atas mata uang dan kebijakan moneter. Namun, tidak semua penolakan ini didasarkan pada fakta. Oleh karena itu, sangat penting untuk mendekati kritik ini dengan pola pikir kritis.

Dengan menilai secara objektif setiap penolakan yang Anda temui, Anda dapat lebih baik menavigasi lautan kritik yang tidak berdasar. Ambil inisiatif untuk mendidik diri Anda sendiri tentang kompleksitas Bitcoin dan stablecoin, menyelami teknologi yang mendasarinya, dan lebih jauh menjelajahi potensi mereka untuk inovasi keuangan dan pemberdayaan.

Pada akhirnya, masa depan keuangan terdesentralisasi berada di tangan mereka yang bersedia melangkah keluar dari batasan konvensi, menantang anggapan yang sudah ada, dan mengevaluasi informasi secara objektif. Berusahalah untuk membuat keputusan yang tepat tentang Bitcoin dan stablecoin berdasarkan pengetahuan yang akurat dan pemahaman yang seimbang tentang kemampuan dan keterbatasan mereka.
...
Berikut adalah beberapa contoh kondisi yang masih dihadapi perempuan di seluruh dunia saat ini:

1. Pembatasan dalam membuka rekening bank: Di [72](https://www3.weforum.org/docs/WEF_GGGR_2020.pdf) negara di seluruh dunia, perempuan tidak diizinkan membuka rekening bank atas nama mereka sendiri. Ini berarti mereka tidak dapat mengakses layanan keuangan, menyimpan uang, atau mengontrol kehidupan finansial mereka.
2. Ketergantungan pada kerabat laki-laki: Di banyak masyarakat patriarki, perempuan bergantung pada kerabat laki-laki untuk dukungan finansial. Ini berarti bahwa mereka tidak dapat membuat keputusan keuangan untuk diri mereka sendiri dan seringkali berada di bawah belas kasihan kerabat laki-laki mereka. Misalnya, di Afghanistan, perempuan sering harus mengandalkan anggota keluarga laki-laki untuk bantuan finansial, dan mereka mungkin tidak dapat mengakses layanan keuangan tanpa izin dari wali laki-laki.
3. Pembatasan dalam pekerjaan: Di beberapa negara, perempuan tidak diizinkan bekerja di luar rumah, yang membuat sulit bagi mereka untuk mencapai kemandirian finansial. Misalnya, di Suriah, Irak, Afghanistan, Aljazair, Palestina, Yordania, dan Iran, perempuan hanya menyumbang antara [15 - 18%](https://www.worldatlas.com/articles/countries-where-women-are-least-likely-to-join-the-labor-force.html) dari angkatan kerja.
4. Kurangnya Hak Milik: Masih ada [75](https://blogs.worldbank.org/opendata/where-world-do-women-still-face-legal-barriers-own-and-administer-assets) negara di seluruh dunia di mana perempuan tidak memiliki hak milik, yang berarti mereka terbatas dalam kemampuan untuk memiliki tanah atau aset lainnya. Hal ini membuat mereka sulit untuk memulai bisnis atau mengakses kredit, karena mereka tidak memiliki jaminan untuk ditawarkan. Sebagai contoh, di beberapa bagian India, perempuan tidak diizinkan untuk memiliki properti, dan mereka mungkin tidak dapat mengakses kredit tanpa izin dari kerabat laki-laki.
...
Afganistan adalah negara yang telah dilanda konflik selama beberapa dekade, dan situasi bagi perempuan di negara tersebut sangat buruk. Rezim Taliban yang represif, yang berkuasa dari 1996 hingga 2001, mencabut hak dasar perempuan, termasuk hak untuk pendidikan dan hak untuk bekerja. Bahkan setelah jatuhnya Taliban, perempuan di Afganistan terus menghadapi tantangan signifikan, termasuk akses terbatas ke pendidikan dan kesempatan kerja serta kurangnya kemandirian finansial.

Namun, dalam beberapa tahun terakhir, Bitcoin telah muncul sebagai alat yang kuat untuk pemberdayaan finansial, terutama bagi perempuan yang seringkali termarginalisasi. Salah satu individu yang telah memanfaatkan potensi Bitcoin adalah [Roya Mahboob](https://twitter.com/royamahboob), seorang pengusaha Afgan yang telah menggunakan mata uang digital untuk membantu perempuan di negaranya mengakses layanan keuangan dan mendapatkan kembali martabat mereka.
...
Oleh karena itu, mengingat karakteristiknya yang tanpa kepercayaan, tanpa izin, dan terdesentralisasi, itu menyediakan jalan keluar bagi wanita-wanita ini yang sebelumnya terhalang dari sistem keuangan tradisional.

Roya Mahboob mengenali potensi ini lebih awal dan mulai menggabungkannya ke dalam pekerjaannya dengan Digital Citizen Fund. Ia melihat bahwa Bitcoin dapat menyediakan cara bagi wanita di Afghanistan untuk mengakses layanan keuangan dan mengendalikan kehidupan keuangan mereka.
...
Sejak didirikan, Women's Annex Foundation telah menjadi sukses besar, membantu banyak wanita di Afghanistan untuk mendapatkan kemandirian finansial dan mengendalikan kehidupan keuangan mereka. Dengan mendapatkan bitcoin, wanita-wanita ini dapat melewati lembaga keuangan tradisional dan mengakses layanan keuangan yang sebaliknya tidak tersedia bagi mereka.

Selain menyediakan kemandirian finansial, Bitcoin juga telah memberikan kembali martabat kepada wanita di Afghanistan. Karena Bitcoin bersifat terdesentralisasi, ini telah memungkinkan wanita untuk mengendalikan kehidupan keuangan mereka tanpa memerlukan wali laki-laki. Ini adalah langkah signifikan ke depan di negara di mana wanita sering diperlakukan sebagai warga kelas dua.

Lebih lanjut, dengan bantuan Mahboob dan Bitcoin, wanita-wanita di Afghanistan kini dapat terhubung dengan audiens global. Semoga, dalam tahun-tahun mendatang, wanita-wanita ini akan terus berbagi cerita dan perspektif mereka dengan dunia, membantu meruntuhkan hambatan yang ada antara budaya dan komunitas yang berbeda.
...
Kami berharap Anda menemukan cerita-cerita ini menginspirasi. Dengan demikian, seharusnya jelas bahwa stablecoin, seperti USDt, memainkan peran penting dalam memungkinkan individu mengakses transfer internasional yang cepat dan efisien, faktur dan pembayaran dalam USD, gaji yang dinominasikan dalam USD, dan yang paling penting, penyimpanan nilai yang relatif stabil dibandingkan dengan banyak mata uang yang tidak stabil. Tanpa stablecoin, banyak dari individu ini akan menghadapi hambatan signifikan ketika mencoba masuk ke pasar global, terhubung dengan anggota keluarga internasional, atau menjangkau pelanggan yang sebelumnya tidak dapat diakses. Stablecoin telah membantu meningkatkan konektivitas keuangan mereka dan menyediakan alat yang berharga untuk menavigasi kompleksitas ekonomi global kita.
...
1. Bagaimana Anda melihat konsep nilai dalam hubungannya dengan bitcoin? Apakah Anda berpikir perlu bagi sebuah mata uang untuk didukung oleh sesuatu yang nyata agar berharga?
2. Merenungkan tentang pekerjaan Roya Mahboob dengan Digital Citizen Fund dan Women's Annex Foundation, apa menurut Anda manfaat utama dari menggabungkan teknologi dan Bitcoin dalam inisiatif yang bertujuan memberdayakan wanita di negara berkembang?
3. Seberapa pentingkah kemandirian finansial untuk pemberdayaan wanita, terutama di negara-negara di mana mereka menghadapi berbagai bentuk diskriminasi dan kesempatan yang terbatas? Bisakah Anda memikirkan cara lain selain Bitcoin yang dapat membantu wanita mencapai kemandirian finansial dalam konteks seperti itu?
...
- Memisahkan fakta dari fiksi seputar banyak kesalahpahaman yang terkait dengan Bitcoin dan Stablecoin.
...
Dengan demikian, jika ada satu hal utama yang harus diambil dari kursus ini, itu akan berkisar pada pemahaman perbedaan antara Bitcoin dan stablecoin dengan mengakui proposisi nilai unik yang dibawa oleh masing-masing teknologi ini ke meja.
...
Di sisi lain, Bitcoin menawarkan solusi untuk masalah historis yang terkait dengan sebagian besar bentuk uang—terpusat dan rentan terhadap penyusutan—dengan menawarkan potensi jangka panjang untuk peningkatan daya beli melalui lapisan dasar digital terdesentralisasi yang dibangun di sekitar kelangkaan pasokan, yang menempatkan tata kelola di tangan pengguna. Meskipun volatilitas jangka pendek bitcoin mungkin menjadi penghalang untuk masuk bagi orang dengan modal terbatas, bagi mereka yang memiliki kapasitas untuk melihat jangka panjang, kemampuannya untuk mengubah kehidupan melalui akumulasi kekayaan jangka panjang adalah luar biasa dan tidak tertandingi.
...
Saat kami mengakhiri kursus ini, kami berharap Anda akan mengambil pengetahuan yang diperoleh di sini dan menerapkannya pada kejaran pribadi atau profesional Anda. Apakah Anda menemukan diri Anda menavigasi tantangan finansial, didorong oleh rasa ingin tahu, bercita-cita untuk berinvestasi, atau berusaha memanfaatkan teknologi ini untuk usaha bisnis, kami berharap wawasan berharga yang diperoleh dari kursus ini akan menjadi sangat berharga dalam perjalanan Anda.
